window.chartOptionList = {
    "colors": {
        "lineAreaColor": {
            "start": ["rgba(36,223,240,1)", "rgba(21,171,233,1)", "rgba(70,109,224,1)", "rgba(93,83,215,1)", "rgba(150,74,223,1)", "rgba(111,103,182,1)"],
            "end": ["rgba(36,223,240,0)", "rgba(21,171,233,0)", "rgba(70,109,224,0)", "rgba(93,83,215,0)", "rgba(150,74,223,0)", "rgba(111,103,182,0)"]
        },
        "1-2": ["#27dff0", "#15abe9"],
        "3-5": ["#27dff0", "#15abe9", "#466de0", "#5d53d7", "#964adf"],
        "tree": [
            "#27dff0",
            "#15abe9",
            "#466de0",
