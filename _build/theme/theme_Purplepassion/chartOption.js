window.chartOptionList = {
    "colors": {
        "lineAreaColor": {
            "start": ["rgba(107,248,224,1)", "rgba(104,165,251,1)", "rgba(244,239,108,1)", "rgba(109,73,206,1)", "rgba(69,88,223,1)", "rgba(19,120,182,1)"],
            "end": ["rgba(107,248,224,0)", "rgba(104,165,251,0)", "rgba(244,239,108,0)", "rgba(109,73,206,0)", "rgba(69,88,223,0)", "rgba(19,120,182,0)"]
        },
        "1-2": ["rgba(107,248,224,1)", "rgba(104,165,251,1)"],
        "3-5": ["rgba(107,248,224,1)", "rgba(104,165,251,1)", "rgba(244,239,108,1)", "rgba(109,73,206,1)", "rgba(69,88,223,1)"],
        "tree": ["rgba(107,248,224,1)", "rgba(104,165,251,1)", "rgba(244,239,108,1)", "rgba(109,73,206,1)", "rgba(69,88,223,1)", "rgba(19,120,182,1)"],
    },
    "default": function (option) {
        /*treemap*/
        if (_.isArray(option.series)) {
            for (var i = 0; i < option.series.length; i++) {
                if (option.series[i].type == "treemap") {
                    for (var j = 0; j < option.series[i].data.length; j++) {
                        option.series[i].data[j].itemStyle.normal = {
                            color: chartOptionList.colors["tree"][j]
                        }
                    }
                }
            }
        ...
        if (option.geo) {
            if (option.geo.map == "china") {
                option = _.extend(option, newOption);
                option.backgroundColor = 'rgba(0,0,0,0)';
                option.geo.itemStyle.normal = {
                    areaColor: "rgba(104,165,251,0.6)",
                    borderColor: "#e0ffff"
                }
            }
        }
    ...
    "chartAloneColor00": function (option) {
        option.color = ["rgba(60, 191, 184, 0.9)"];
        return option;
    },
    "chartAloneColor01": function (option) {
        option.color = ["rgba(9, 173, 173, 0.9)"];
        return option;
    },
    "chartAloneColor02": function (option) {
        option.color = ["rgba(17, 153, 163, 0.9)"];
        return option;
    },
    "chartAloneColor03": function (option) {
        option.color = ["rgba(8, 132, 128, 0.9)"];
        return option;
    },
    "chartAloneColor04": function (option) {
        option.color = ["rgba(1, 114, 111, 0.9)"];
        return option;
    },
    "chartAloneColor05": function (option) {
        option.color = ["rgba(15, 96, 96, 0.9)"];
        return option;
    },
    "chartDoubleColor00": function (option) {
    ...
    "chartTreemapColor": function (option) {
        var colors = chartOptionList.colors["tree"];
        var s = option.series;
        if (_.isArray(s)) {
    ...
    "chartAxisStyle01": function (option) {
        var axis = {
            axisLine: {
                lineStyle: {
                    color: ''
    ...
    "chartCategoryFontSize00": function (option) {//设置类轴字号
        if (!_.isArray(option.xAxis)) {
    ...
    "chartCategoryFontSize01": function (option) {//设置类轴字号
        if (!_.isArray(option.xAxis)) {
            option.xAxis.axisLabel.textStyle = {
                fontSize: 12
            }
    ...
    "chartCategoryFontSize02": function (option) {//设置类轴字号
        if (!_.isArray(option.xAxis)) {
            option.xAxis.axisLabel.textStyle = {
                fontSize: 14
            }
    ...
    "chartCategoryFontSize03": function (option) {//设置类轴字号
        if (!_.isArray(option.xAxis)) {
            option.xAxis.axisLabel.textStyle = {
                fontSize: 16
            }
    ...
    "chartCategoryFontSize04": function (option) {//设置类轴字号
        if (!_.isArray(option.xAxis)) {
            option.xAxis.axisLabel.textStyle = {
                fontSize: 18
            }
    ...
    "chartLineIntactRate": function (option) {
    ...
    "chartLineNodeDisplay": function (option) {
        for (var i = 0; i < option.series.length; i++) {
    ...
    "chartDeleteAxis": function (option) {
        var x = option.xAxis,
            y = option.yAxis;
