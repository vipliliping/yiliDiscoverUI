(function () {
  ...
  angular
    .module('discovery')
    .service('adminUser2Service', adminUserService)
    ...
    return exports.service({
      ...
      cached: {
        ...
        getRoleListByUserId(userId) {
          ...
          const userList = _.map(roleIdList, (roleId) => _.findWhere(this.roleList, {roleId}))
          return userList
        }
      },
      created() {
        ...
        async: {// ajax方法
          ...
          fetchAllAsync() {
            return $q.all([
              ...
              this.getRoleListByUserId.clearAll()
              this.getUserListByRoleId.clearAll()
            })
          },
          /**
           * 获得UserList
