 ...
 */
discovery.controller('jobCtrl', function ($scope, $rootScope, $http, dataService, $uibModal, ModalUtils, $filter, $interval) {
    "ngInject";
    ...
    $scope.editJob = function (job) {
        $uibModal.open({
            templateUrl: 'src/view/config/modal/job/edit.html',
            ...
            controller: function ($scope, $uibModalInstance) {
                ...
                $scope.config = function () {
                    $uibModal.open({
                        templateUrl: 'src/view/config/modal/job/' + $scope.job.jobType + '.html',
                        windowTemplateUrl: 'src/view/util/modal/window.html',
                        backdrop: false,
                        size: 'lg',
                        scope: $scope,
