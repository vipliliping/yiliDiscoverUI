 ...
 */
'use strict'
discovery.controller('widgetCtrl', function ($scope, $stateParams, $http, $uibModal, dataService, ModalUtils, updateService, $filter, chartService, $timeout) {
    "ngInject"
    ...
    $scope.chart_types = [
      {
        name: translate('CONFIG.WIDGET.CITYMAP'), value: 'cityMap', class: 'cCityMap',
      ...
      {
        name: translate('CONFIG.WIDGET.CITYMAP'), value: 'zoneMap', class: 'cZoneMap',
        row: translate('CONFIG.WIDGET.TIPS_DIM_NUM_0'),
        column: translate('CONFIG.WIDGET.TIPS_DIM_NUM_0'),
        measure: translate('CONFIG.WIDGET.TIPS_DIM_NUM_1_MORE')
      },
      {
        name: translate('CONFIG.WIDGET.CHORD'), value: 'chord', class: 'cChord',
      ...
      {
        name: translate('CONFIG.WIDGET.LINE_BAR2'), value: 'line2', class: 'cLine',
        row: translate('CONFIG.WIDGET.TIPS_DIM_NUM_1_MORE'),
        column: translate('CONFIG.WIDGET.TIPS_DIM_NUM_0_MORE'),
        measure: translate('CONFIG.WIDGET.TIPS_DIM_NUM_1_MORE')
      },
      {
        name: translate('CONFIG.WIDGET.LINE_BAR3'), value: 'line3', class: 'cLine',
        row: translate('CONFIG.WIDGET.TIPS_DIM_NUM_1_MORE'),
        column: translate('CONFIG.WIDGET.TIPS_DIM_NUM_0_MORE'),
        measure: translate('CONFIG.WIDGET.TIPS_DIM_NUM_1_MORE')
      },
      ...
      {
        name: translate('CONFIG.WIDGET.SCATTER2'), value: 'scatter2', class: 'cScatter2',
        row: translate('CONFIG.WIDGET.TIPS_DIM_NUM_1_MORE'),
        column: translate('CONFIG.WIDGET.TIPS_DIM_NUM_0_MORE'),
        measure: translate('CONFIG.WIDGET.TIPS_DIM_NUM_1_MORE')
      },
    ...
    $scope.chart_types_status = {
      "line": true, "line2": true, "line3": true, "pie": true, "kpi": true, "table": true,
      "funnel": true, "sankey": true, "radar": true, "map": true,
      "scatter": true, "scatter2": true, "gauge": true, "wordCloud": true, "treeMap": true,
      "areaMap": true, "heatMapCalendar": true, "heatMapTable": true,
      "markLineMap": true, "liquidFill": true, "chord": true, "cityMap": true, "zoneMap": true
    }
     ...
     ***************************************/
    $scope.configRule = {
      // cityMap: {keys: 2, groups: 0, filters: -1, values: 1},
      chord: {keys: -1, groups: 0, filters: -1, values: 2},
      line: {keys: 2, groups: -1, filters: -1, values: 2},
      line2: {keys: 2, groups: -1, filters: -1, values: 2},
      line3: {keys: 2, groups: -1, filters: -1, values: 2},
      ...
      scatter2: {keys: 2, groups: -1, filters: -1, values: 2},
...
// };
    ...
    $scope.getChartView = function () {
      if ($scope.curWidget.config && $scope.curWidget.config.chart_type) {
        return 'src/view/config/chart/' + $scope.curWidget.config.chart_type + '.html'
      }
    }

    $scope.getOptionsView = function () {
      var basePath = 'src/view/config/chart/options/'
      if ($scope.curWidget.config && $scope.curWidget.config.chart_type) {
    ...
    $scope.editFilter = function (setbackArr, setbackIdx) {
      $uibModal.open({
        templateUrl: 'src/view/dashboard/modal/param.html',
        windowTemplateUrl: 'src/view/util/modal/window.html',
        backdrop: false,
        size: 'lg',
        resolve: {
    ...
    $scope.editVFilter = function (o) {
      $uibModal.open({
        templateUrl: 'src/view/config/modal/vfilter.html',
        windowTemplateUrl: 'src/view/util/modal/window.html',
        backdrop: false,
        size: 'lg',
        controller: function ($scope, $uibModalInstance) {
