...
discovery.controller('dashboardViewCtrl', function ($timeout, $rootScope, $scope, $state, $stateParams, $http, ModalUtils, chartService, $interval, $uibModal, dataService, $q) {
    "ngInject";
    ...
    $scope.modalChart = function (widget) {
        $uibModal.open({
            templateUrl: 'src/view/util/modal/chart.html',
